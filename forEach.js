...
function addKeyAndValue(arr,key,value){
    //Your Code Here
    var obj = {}
    arr.forEach(x=>{obj[Object.keys(x) + " = " + x.name]
    = key + " = "+ value; 
    });
    return obj;
}
...
* Write a function called vowelCount
 which accepts a string and returns an object
  with the keys as the vowel 
 and the  values as the number
  of times the vowel appears in the string.
